...
* ```text
    "Scan this dataset. Standardize all municipal waste measurements into standard Metric Tons per Year (MT/Year). Identify any null or missing values in the 2022 and 2023 rows and impute them using the rolling 3-year historical average for that specific local government unit. Output the clean baseline data."
    ```
